    ...
    <div className="min-height-screen min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slateDark-muted text-sm mt-1.5 font-medium">Create your FocusFlow account and boost focus.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-xs font-bold text-slateDark-muted uppercase tracking-wider mb-2">Username</label>
        ...
        <div className="text-center mt-6">
          <p className="text-xs text-slateDark-muted font-medium">
            ...
            <Link to="/login" className="text-focusFlow-indigo hover:text-focusFlow-purple font-semibold hover:underline">
              Log In
            </Link>
          </p>
        </div>
